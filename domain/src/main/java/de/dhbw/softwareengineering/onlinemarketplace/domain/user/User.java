...
public final class User {
    ...
    public User(Name name, String email, String password) {
        ...
        Validate.notBlank(email, "The email cannot be null");
        Validate.isTrue(EmailValidator.getInstance().isValidEmail(email), "The email needs to be a valid email");
        Validate.notBlank(password, "The password cannot be null");
